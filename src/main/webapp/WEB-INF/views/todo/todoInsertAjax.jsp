					...
					<div class="issueSelectPage">
						<div class="issueSelectPageLeft">
							<form action="#" method="post">
								...
								<div class="issues">
									...
									<div class="issuesRight">
										<ul>
											...
											<li>
												<select style="display:none" id="pmember_member" name="pmember_member"></select>
								...
								<input type="button" id="todoUpdateBtn" value="수정" class="issueUpdateBtnLeft" onclick="attrChangeUpdate${todo.todo_work}(${todo.todo_id});">
							</form>
						</div>
