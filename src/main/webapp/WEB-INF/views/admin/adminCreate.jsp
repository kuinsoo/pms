...
.adminCreateList{width:80px;height:40px;background-color:#fa2828;color:#fff;border:none;cursor:pointer;font-size:17px;float:left;outline:none;}
	...
	<div class="adminRightContent">
		...
		<div class="adminRightContentInner">
			...
			<div class="adminTitleInputContent">
				<table>
					...
					<tr>
						...
						<td>
							<textarea id="smarteditor">내용</textarea>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="adminCreateBtns">
				<input type="button" value="목록" class="adminCreateList" onclick="adminList();" />
				<input type="button" value="등록" class="adminCreateBtn" />
